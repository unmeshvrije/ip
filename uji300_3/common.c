...
FILE *pLogFile;
  ...
  pLogFile = fopen(szFilePath, "a"); // Open in append mode
  ...
  switch(iLevel)
  {
	...
	default : 
	    // LOGLEVEL_ERROR
	    //
	    //A valid lastError cannot be zero as per man page of errno. Hence using 0 when lastError is not specified.
	    //
